...
function cr_scripts() {
    ...
    wp_enqueue_style( 'base_font', 'https://fonts.googleapis.com/css?family=Playfair+Display' );
    wp_enqueue_style( 'font', 'https://fonts.googleapis.com/css?family=Parisienne' );
